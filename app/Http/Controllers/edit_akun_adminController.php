...
class edit_akun_adminController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        if ($request->session()->has('user')) {
            ...
            return view('edit_akun_admin', compact('user'));
        } else {
    ...
    public function simpan_akun_admin(Request $request)
    {
        $id = $request->id;
        ...
        $user = $request->user();
        return redirect()->route('akun_admin', ['data' => $user->username]);
    }
}

...
class progres_pengajuan_sertifikasi_adminController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        if ($request->session()->has('user')) {
            ...
            return view('progres_pengajuan_sertifikasi_admin', compact('user','progres','kemajuan','keterangan_kemajuan'));
        } else {

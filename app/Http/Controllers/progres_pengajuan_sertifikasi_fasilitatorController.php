...
class progres_pengajuan_sertifikasi_fasilitatorController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        if ($request->session()->has('user')) {
            ...
            return view('progres_pengajuan_sertifikasi_fasilitator', compact('user','progres','kemajuan','keterangan_kemajuan'));
        } else {
